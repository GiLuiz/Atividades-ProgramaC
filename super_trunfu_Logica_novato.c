...
int main(){
  ...
  //  scanf("%s", cidadeB);
    ...
    // printf("Nome do estado: %s\n", cidadeB);
     ...
     //Comparação entre os estados A e B
     ...
     //comparação do pib per capita entre os estados A e B
     printf("Comparacao entre do pib per capita entre carta 1 e carta 2:\n");
     if(PibPopA > PibPopB) {
        printf("Pib do estado A e maior entao Carta 1 vence");
     }else{
        printf("Pib do estado B e maior entao Carta 2 vence");
     } 
